...
function RealizarMovComponente({ isOpenAutorizarMovEqAd, onCloseAutorizarMovEqAd, childrenAutorizarMovEqAd, infoMovEq}){
...
const storedUserData = JSON.parse(storedJsonString);
  ...
  const handleSubmit = async(event) => {
    ...
    try{
      ...
      const logear = await fetch('http://localhost:4000/realizar/movimiento/componentes',{
        method: 'POST',
        body: JSON.stringify({infoMovEq,autorizar: event.target.value, codPer: storedUserData.usuario}),
        ...
        <div className="modal-overlay">
            <div className="modal">
              ...
              <div>
                ...
                <p>Nombre de solicitante: {infoMovEq.detalleMov.personalMov[0].Autorizador}</p>
              ...
              <div><button className='enviar' onClick={handleSubmit}>Realizar Movimiento</button></div>
...
export default RealizarMovComponente