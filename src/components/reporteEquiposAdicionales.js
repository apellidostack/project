  ...
  return (
    <View style={styles.container}>
      <View style={{fontSize: '10px', textAlign: 'center', width: '170px'}}>
        ...
        <Text style={{marginBottom: '10px', textAlign: 'center',marginTop: '30px', width:'80%', padding: '3px', fontSize: '16px', fontFamily: 'Times-Roman'}}>INFORME DE EQUIPOS DE COMPUTACIÓN</Text>
        <Text style={{marginBottom: '10px', textAlign: 'center', width:'80%', padding: '3px', fontSize: '16px', fontFamily: 'Times-Roman'}}>ADICIONALES</Text>
...
const PDFGeneratorAdicional = (props) => {
...
export default PDFGeneratorAdicional;
