...
import EquiposParaMover from './modalDetalleRealizar';
...
//movimientos autorizados
 ...
 const listaMovimientoAutorizados = async ()=>{
   try{
     // Aquí puedes realizar alguna acción con los datos del formulario, como enviarlos a un servidor
     const datos = await fetch('http://localhost:4000/get/movimientos/autorizados',{
     })
...
//
  ...
  const handleSubmit = async(event) => {
    ...
    try{
      // Aquí puedes realizar alguna acción con los datos del formulario, como enviarlos a un servidor
      const logear = await fetch('http://localhost:4000/set/movimiento',{
        method: 'POST',
    ...
    <section className="container">
      <div className='solicitudes'>
          <div className='row-grid'>
            <div><h1>Solicitar Movimiento de Equipo</h1></div>
            <div className='col'>
      ...
      <div>
      <button className='enviar2' onClick={handleSubmit}>Realizar solicitud</button>
      </div>
      
      <Box sx={{ height: 400, width: '100%' }}>
        <div><h3>Movimientos Autorizados</h3></div>
      <DataGrid
    ...
    <div>
            <EquiposParaMover isOpenAutorizarMovEq={modalOpenAMovEq} onCloseAutorizarMovEq={handleCloseModalAMovEq} infoMovEq={{detalleMov}}>
...
export default SolicitarMovimiento