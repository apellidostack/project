...
function EquiposParaMover({ isOpenAutorizarMovEq, onCloseAutorizarMovEq, childrenAutorizarMovEq, infoMovEq}){
...
const storedUserData = JSON.parse(storedJsonString);
  ...
  const handleSubmit = async(event) => {
    ...
    try{
      ...
      const logear = await fetch('http://localhost:4000/realizar/movimiento',{
        method: 'POST',
        ...
        <div className="modal-overlay">
            <div className="modal">
              ...
              <div>
                ...
                <p>{`Se autoriza el movimiento de equipos de laboratorio: ${infoMovEq.detalleMov.labMov[0].labAnterior+' al laboratorio: '+infoMovEq.detalleMov.labMov[0].NroLab} `}</p>
...
export default EquiposParaMover