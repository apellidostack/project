...
function ReporteTotalAdicional() {
    let arr=[];
...
useEffect(()=>{
  ...
  const handleChangeSelect = async (e)=>{
    try{
      // Aquí puedes realizar alguna acción con los datos del formulario, como enviarlos a un servidor
      const datos = await fetch('http://localhost:4000/get/reporte/equipo/adicional',{
        method: 'POST',
 ...
 */
  ...
  return (
    ...
    <section className="container">
        <h3>Generar PDF de Informe de Equipo Adicionales</h3>
    <div className='col'>
      ...
      <div className="ReportePdf">
        ...
        {(opciones.length > 0)?(
            <PDFGeneratorAdicional info={opciones} nombre={nomRep}/>
        ):null}
...
export default ReporteTotalAdicional;
