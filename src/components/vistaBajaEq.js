...
import AddMotivoBajaEquipo from './modalMotivoBajaEquipo';

import Box from '@mui/material/Box';
import { DataGrid } from '@mui/x-data-grid';
import EquipoParaDarBaja from './modalDetalleRealizarBajaEquipo';
...
//movimientos autorizados
 ...
 const listaMovimientoAutorizados = async ()=>{
   try{
     // Aquí puedes realizar alguna acción con los datos del formulario, como enviarlos a un servidor
     const datos = await fetch('http://localhost:4000/get/bajas/autorizados',{
     })
...
//
  ...
  const selectMotivos = async ()=>{
    try{
      // Aquí puedes realizar alguna acción con los datos del formulario, como enviarlos a un servidor
      const datos = await fetch('http://localhost:4000/get/motivo/baja/equipo',{
  ...
  useEffect(()=>{
    ...
    const handleChangeSelect=async(e)=>{
      ...
      try{
        // Aquí puedes realizar alguna acción con los datos del formulario, como enviarlos a un servidor
        const logear = await fetch('http://localhost:4000/get/equipos/baja',{
          method: 'POST',
  ...
  const handleSubmit = async(event) => {
   ...
   /* console.log(formDataLabs);
    Object.entries(formData).map((valData)=>{
     ...
     try{
      // Aquí puedes realizar alguna acción con los datos del formulario, como enviarlos a un servidor
      const logear = await fetch('http://localhost:4000/set/baja/equipo',{
        method: 'POST',
    ...
    <section className="container">
      <div className='solicitudes'>
          <div className='row-grid'>
            <div><h1>Solicitar Baja de Equipo</h1></div>
            <div className='col'>
            ...
            <div className='lb-imp'>
            <div className='lb-center'>
              <label>Motivo de baja</label></div>
    ...
    <div>
            <EquipoParaDarBaja isOpenAutorizarMovEq={modalOpenAMovEq} onCloseAutorizarMovEq={handleCloseModalAMovEq} infoMovEq={{detalleMov}}>

            </EquipoParaDarBaja>
            </div>
      <div>
        <AddMotivoBajaEquipo isOpenMs={modalOpenMotSoli} onCloseMs={handleCloseModalMs}>
