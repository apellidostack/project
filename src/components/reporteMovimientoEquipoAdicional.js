  ...
  return (
    <View style={styles.container}>
      <View style={{fontSize: '10px', textAlign: 'center', width: '170px'}}>
        ...
        <Text style={{marginBottom: '10px', textAlign: 'center',marginTop: '30px', width:'80%', padding: '3px', fontSize: '16px', fontFamily: 'Times-Roman'}}>INFORME DE MOVIMIENTO DE EQUIPOS ADICIONALES</Text>
        <Text style={{marginBottom: '10px', textAlign: 'center', width:'80%', padding: '3px', fontSize: '16px', fontFamily: 'Times-Roman'}}>EN LA GESTIÓN 2023</Text>
        </View>
        <View style={{display: 'flex', alignItems: 'center'}}>
        <Text style={{marginBottom: '10px', textAlign: 'center',marginTop: '30px', width:'80%', padding: '3px', fontSize: '16px', fontFamily: 'Times-Roman'}}>MOVIMIENTO EN {format(new Date(props.infoComp[0].FechaMov), 'dd/MM/yyyy')}</Text>
        </View>
        <View><Text style={[{color: 'black',fontSize: 12,marginBottom: '5px'}]}>REALIZADO POR: {props.realizadoPor}</Text></View>
        <View style={[styles.centrar,{marginBottom: '10px'}]}>
        <View style={styles.datos}>
            <Text style={[styles.bordeComp,{backgroundColor: 'blue',color: 'white',width: '18%'}]}>Se movio</Text>
            <Text style={[styles.bordeComp,{backgroundColor: 'blue',color: 'white',width: '18%'}]}>como</Text>
        </View>
      ...
      return(
        ...
        <View style={styles.datos}>
          <Text style={[styles.bordeComp,{backgroundColor: 'rgb(255, 247, 203)',width: '18%'}]}>{datos.nomAdAnterior}</Text>
          <Text style={[styles.bordeComp,{backgroundColor: 'rgb(255, 247, 203)',width: '18%'}]}>{datos.nomAdNuevo}</Text>
        </View>
        ...
        return(
          ...
          <View style={styles.datos}>
            ...
            <Text style={[styles.bordeComp,{backgroundColor: 'rgb(255, 247, 203)',width: '15%'}]}>{datos.nomAdNuevo}</Text>
...
export default PDFMovimientoEquipoAdicional;
