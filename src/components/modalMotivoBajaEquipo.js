...
function AddMotivoBajaEquipo({ isOpenMs, onCloseMs, childrenMs }){
  ...
  const handleSubmit = async(event) => {
    ...
    try{
      ...
      const logear = await fetch('http://localhost:4000/set/motivo/baja/equipo',{
        method: 'POST',
  ...
  if (!isOpenMs) {return null;}
    return(
        ...
        <form>
            <div>
          <h2>Agregar Motivo para Baja de Equipo</h2>
        </div>
        <div className='fila'>
...
export default AddMotivoBajaEquipo